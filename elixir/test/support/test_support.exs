defmodule SymphonyElixir.TestSupport do
  ...
  defp workflow_content(overrides) do
    ...
    workspace_archive_root = Keyword.get(config, :workspace_archive_root)
    ...
    sections =
      [
        ...
        workspace_archive_root && "  archive_root: #{yaml_value(workspace_archive_root)}",
